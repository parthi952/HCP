  ...
  return (
    <div className={`flex flex-col gap-1.5 w-full ${className}`}>
      ...
      <div className="relative group">
        <select
          className={`flex h-12 w-full appearance-none rounded-xl border bg-slate-50 pl-4 pr-11 py-2 text-[15px] placeholder:text-gray-400 focus:bg-white focus:outline-none focus:ring-2 focus:border-transparent transition-all disabled:cursor-not-allowed disabled:opacity-50 shadow-sm ${
            error 
